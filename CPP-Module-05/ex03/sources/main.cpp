...
/*   Updated: 2023/07/31 08:46:26 by mtigunit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main() {
	...
	Intern		intern;
	AForm		*form = intern.makeForm("presidential pardon", "PP_target");
	AForm		*form2 = intern.makeForm("robotomy request", "RR_target");
	AForm		*form3 = intern.makeForm("shrubbery creation", "SC_target");

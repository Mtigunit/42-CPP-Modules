...
ClapTrap::ClapTrap() : name("Default"), Health(100), energyPoints(50), attackDamage(20) {
...
ClapTrap::ClapTrap( std::string name ) : name(name), Health(100), energyPoints(50), attackDamage(20) {

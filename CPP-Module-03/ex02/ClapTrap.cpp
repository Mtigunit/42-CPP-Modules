...
ClapTrap::ClapTrap() : name("Default"), Health(100), energyPoints(100), attackDamage(30) {
...
ClapTrap::ClapTrap( std::string name ) : name(name), Health(100), energyPoints(100), attackDamage(30) {
